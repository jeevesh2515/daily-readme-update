# Template for https://github.com/jeevesh2515/homebrew-tap after a tagged release.
# Replace sha256 with the real v1.0.1 source archive hash before publishing.
